...
import com.test.socket.ServerSocketConfiguration;
import com.test.socket.SocketConfiguration;
...
public final class SocketUtils {
    ...
    public static void closeQuietly(final Socket socket) {
        ...
        try {
            ...
            log.debug("Failed to close socket due to: " + ex, ex);
        }
    }
    ...
    public static void closeQuietly(final ServerSocket serverSocket) {
        ...
        try {
            ...
            log.debug("Failed to close server socket due to: " + ex, ex);
        }
    }
